...
#Authour @ Bhavya
{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "customer = spark.read.csv('/Users/dilipkumarvemula/Desktop/Python_PRa/customer_churn.csv', inferSchema=True, header=True)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "metadata": {
    ...
    "colab_type": "code",
    "id": "FToE0f51-Dcp",
    "outputId": "c8b472d4-9478-415d-ba68-3bc5d11402df"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "colab_type": "code",
    "id": "6hVVyYEvEU9j",
    "outputId": "c8d4cda7-ac1f-474d-b154-a242a37592b3"
   },
   "outputs": [
    {
     "name": "stdout",
   ...
   "source": [
    "customer.select(['Names','Age']).show(10)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "metadata": {
    ...
    "colab_type": "code",
    "id": "h_BoUtuREj2x",
    "outputId": "9767b3c5-effc-4be8-f005-4d39151b42e5"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "colab_type": "code",
    "id": "vY6GZbULGZBM",
    "outputId": "498b6ae9-575c-44bb-fb35-67dc0ebf62d9"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "l_regression = LogisticRegression(labelCol='churn')"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "lr_model = l_regression.fit(train)"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "colab_type": "code",
    "id": "ECAKEhrPJ8Tf",
    "outputId": "52595e80-9b67-425b-ca59-f7a2e442293e"
   },
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "+--------------------+-----+--------------------+--------------------+----------+\n",
      "|[26.0,8787.39,1.0...|  1.0|[0.61013240185684...|[0.64797100414251...|       0.0|\n",
      "|[26.0,8939.61,0.0...|  0.0|[5.89706560861053...|[0.99726003281894...|       0.0|\n",
      "|[28.0,8670.98,0.0...|  0.0|[7.19376288517121...|[0.99924930706152...|       0.0|\n",
      "|[28.0,9090.43,1.0...|  0.0|[1.44282391524470...|[0.80889157002138...|       0.0|\n",
      "|[28.0,11128.95,1....|  0.0|[3.95871351829198...|[0.98126986001796...|       0.0|\n",
      "|[28.0,11204.23,0....|  0.0|[1.75830000961572...|[0.85299662054281...|       0.0|\n",
      "|[28.0,11245.38,0....|  0.0|[3.50041038451103...|[0.97069944367370...|       0.0|\n",
      "|[29.0,5900.78,1.0...|  0.0|[3.75941012748356...|[0.97723293631990...|       0.0|\n",
      "|[29.0,8688.17,1.0...|  1.0|[2.52884156759301...|[0.92613914944419...|       0.0|\n",
      "|[29.0,9378.24,0.0...|  0.0|[4.41249717668615...|[0.98802038857256...|       0.0|\n",
      "|[29.0,9617.59,0.0...|  0.0|[4.11590436931259...|[0.98395060224989...|       0.0|\n",
      "|[29.0,12711.15,0....|  0.0|[5.04761718756272...|[0.99361638840796...|       0.0|\n",
      "|[29.0,13240.01,1....|  0.0|[6.37786103235928...|[0.99830412821639...|       0.0|\n",
      "|[29.0,13255.05,1....|  0.0|[3.99084626854342...|[0.98185139497886...|       0.0|\n",
      "|[30.0,6744.87,0.0...|  0.0|[3.17914475549724...|[0.96004187050988...|       0.0|\n",
      "|[30.0,8403.78,1.0...|  0.0|[5.52508979283379...|[0.99603031043490...|       0.0|\n",
      "|[30.0,8677.28,1.0...|  0.0|[3.85840265857835...|[0.97933439966563...|       0.0|\n",
      "|[30.0,8874.83,0.0...|  0.0|[2.92519539150710...|[0.94907797364667...|       0.0|\n",
      "|[30.0,10183.98,1....|  0.0|[2.74365478233294...|[0.93955399387962...|       0.0|\n",
      "|[30.0,10744.14,1....|  1.0|[1.67869977362108...|[0.84273228293775...|       0.0|\n",
      "+--------------------+-----+--------------------+--------------------+----------+\n",
      "only showing top 20 rows\n",
      "\n"
     ]
  ...
  },
  {
   ...
   "metadata": {
    ...
    "colab_type": "code",
    "id": "5U1IXI5FKGkx",
    "outputId": "7d7c4526-3e68-4861-ad3f-e2dcb503f26d"
   },
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "+-------+------------------+-------------------+\n",
      "|  count|               640|                640|\n",
      "|   mean|            0.1625|           0.115625|\n",
      "| stddev|0.3691974123209368|0.32002481809080563|\n",
      "|    min|               0.0|                0.0|\n",
      "|    max|               1.0|                1.0|\n",
      "+-------+------------------+-------------------+\n",
      "\n"
  ...
  },
  {
   ...
   "metadata": {
    ...
    "colab_type": "code",
    "id": "zUn05YQeKPmD",
    "outputId": "8a305af2-6e6a-4573-c300-24185094996f"
   },
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "|            features|churn|       rawPrediction|         probability|prediction|\n",
      "+--------------------+-----+--------------------+--------------------+----------+\n",
      "|[22.0,11254.38,1....|    0|[4.36283739254959...|[0.98741813862709...|       0.0|\n",
      "|[25.0,9672.03,0.0...|    0|[4.33003415348006...|[0.98700402153895...|       0.0|\n",
      "|[27.0,8628.8,1.0,...|    0|[5.07112230104476...|[0.99376376139623...|       0.0|\n",
      "|[29.0,10203.18,1....|    0|[3.55400644992570...|[0.97218596746509...|       0.0|\n",
      "|[29.0,11274.46,1....|    0|[4.26329197082538...|[0.98611949184610...|       0.0|\n",
      "|[30.0,7960.64,1.0...|    1|[2.93220158015401...|[0.94941551216612...|       0.0|\n",
      "|[30.0,12788.37,0....|    0|[2.40302606047468...|[0.91705776487763...|       0.0|\n",
      "|[30.0,13473.35,0....|    0|[2.63764319348202...|[0.93324528870219...|       0.0|\n",
      "|[31.0,5304.6,0.0,...|    0|[3.07024761449999...|[0.95564866856000...|       0.0|\n",
      "|[31.0,5387.75,0.0...|    0|[2.26390613701731...|[0.90584331872991...|       0.0|\n",
      "|[31.0,8688.21,0.0...|    0|[6.13418213235480...|[0.99783719066421...|       0.0|\n",
      "|[31.0,8829.83,1.0...|    0|[4.14822912566042...|[0.98445316319423...|       0.0|\n",
      "|[31.0,10182.6,1.0...|    0|[4.51842307127574...|[0.98921145370576...|       0.0|\n",
      "|[32.0,6367.22,1.0...|    0|[2.78770771089720...|[0.94200794612418...|       0.0|\n",
      "|[32.0,8617.98,1.0...|    1|[0.99499200617538...|[0.73007280866895...|       0.0|\n",
      "|[32.0,9472.72,1.0...|    0|[3.69936213378014...|[0.97585795552106...|       0.0|\n",
      "|[32.0,11715.72,0....|    0|[3.20566589330554...|[0.96104693895423...|       0.0|\n",
      "|[32.0,12479.72,0....|    0|[4.33705224539489...|[0.98709373618802...|       0.0|\n",
      "|[33.0,10306.21,1....|    0|[1.94269760691965...|[0.87464820469750...|       0.0|\n",
      "|[33.0,10709.39,1....|    0|[5.86918315703727...|[0.99718277903641...|       0.0|\n",
      "+--------------------+-----+--------------------+--------------------+----------+\n",
      "only showing top 20 rows\n",
      "\n"
     ]
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "accuracy = BinaryClassificationEvaluator(rawPredictionCol='prediction', labelCol='churn').evaluate(pred_and_labels.predictions)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "metadata": {
    ...
    "colab_type": "code",
    "id": "Vezoi8a0MIvB",
    "outputId": "e0d486a2-2c34-4797-af87-b42edfbabc96"
   },
   "outputs": [],
   "source": [
    "accuracy"
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "_,customer = customer_churn.randomSplit([0.7, 0.3])"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "predict_lr_model = l_r.fit(final)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "metadata": {
    ...
    "colab_type": "code",
    "id": "AsuJjQL84659",
    "outputId": "98558d99-0ca4-4af5-cc22-85959286d52d"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "test_customers = vec_assembler.transform(customer)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "P_result = predict_lr_model.transform(test_customers)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "metadata": {
    ...
    "colab_type": "code",
    "id": "33FQl1O7dxym",
    "outputId": "7b20067b-394f-40c6-d558-988c6f8d3a10"
   },
   "outputs": [
    {
     "name": "stdout",
   ...
   "source": [
    "P_result.select('Company', 'prediction').show()"
   ]
  },
  {
   "cell_type": "code",
